...
import static loci.formats.IFormatReader.MUST_GROUP;
import loci.formats.MetadataTools;
import loci.formats.in.BaseTiffReader;
import static loci.formats.in.BaseTiffReader.DATE_FORMATS;
...
public class NDPIReader extends BaseTiffReader {
  ...
  public byte[] openBytes(int no, byte[] buf, int x, int y, int w, int h) throws FormatException, IOException {
    ...
    System.out.println("PARAMS : "+buf.length+" "+x+" "+y+" "+w+" "+h);
    service.getTile(buf, x, y, w, h);
    System.out.println("BUFFER SIZE HERE : "+buf.length);
    return buf;
  }
